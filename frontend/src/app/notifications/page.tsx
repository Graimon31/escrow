    ...
    <>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          {unreadCount > 0 && (
            <p className="mt-1 text-sm text-gray-500">{unreadCount} непрочитанных</p>
          )}
        </div>
        {unreadCount > 0 && (
          <button
      ...
      {notifications.length === 0 ? (
        <div className="rounded-lg bg-white p-12 text-center shadow-sm">
          ...
          <p className="mt-1 text-xs text-gray-400">Здесь появятся уведомления об обновлениях сделок</p>
        </div>
      ) : (
