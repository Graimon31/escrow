    ...
    <>
      ...
      {deals.length === 0 ? (
        <div className="rounded-lg bg-white p-12 text-center shadow-sm">
          <p className="text-sm text-gray-500">No deals yet. Documents are attached to deals.</p>
        </div>
      ) : (
        <>
          <div className="mb-4">
          ...
          {documents.length === 0 ? (
            <div className="rounded-lg bg-white p-12 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-500">No documents for this deal</p>
              <p className="mt-1 text-xs text-gray-400">Upload a document using the button above</p>
            </div>
          ) : (
                ...
                <tbody className="divide-y divide-gray-200">
                  {documents.map((doc) => (
                    <tr key={doc.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-500">{new Date(doc.createdAt).toLocaleString()}</td>
